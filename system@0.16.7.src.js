...
(function() {
  ...
  if (typeof document != 'undefined') {
    ...
    if (!$__global.System || !$__global.LoaderPolyfill) {
      ...
      document.write(
        '<' + 'script type="text/javascript" src="' + basePath + 'es6-module-loader@0.16.5.js" data-init="upgradeSystemLoader">' + '<' + '/script>'
      );
    }
    else {
    ...
    if (!$__global.System || !$__global.LoaderPolyfill) {
      ...
      importScripts(basePath + 'es6-module-loader@0.16.5.js');
      $__global.upgradeSystemLoader();
    } else {
      $__global.upgradeSystemLoader();
    }
