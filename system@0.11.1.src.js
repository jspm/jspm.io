...
(function() {
  ...
  if (isBrowser) {
    ...
    if (!$__global.System || !$__global.LoaderPolyfill) {
      ...
      document.write(
        '<' + 'script type="text/javascript" src="' + basePath + 'es6-module-loader@0.11.1.js" data-init="upgradeSystemLoader">' + '<' + '/script>'
      );
    }
    else {
    ...
    if (!$__global.System || !$__global.LoaderPolyfill) {
      ...
      importScripts(basePath + 'es6-module-loader@0.11.1.js');
    } else {
      $__global.upgradeSystemLoader();
    }
  }
