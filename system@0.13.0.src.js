...
(function() {
  ...
  if (isBrowser) {
    ...
    if (!$__global.System || !$__global.LoaderPolyfill) {
      ...
      document.write(
        '<' + 'script type="text/javascript" src="' + basePath + 'es6-module-loader@0.13.0.js" data-init="upgradeSystemLoader">' + '<' + '/script>'
      );
    }
    else {
    ...
    if (!$__global.System || !$__global.LoaderPolyfill) {
      ...
      importScripts(basePath + 'es6-module-loader@0.13.0.js');
    } else {
      $__global.upgradeSystemLoader();
    }
  }
...
(function(global) {
  var upgrade = global.upgradeSystemLoader;
  global.upgradeSystemLoader = function() {
    ...
    System.config({
      paths: {
        ...
        '@traceur': 'https://jspm.io/traceur@0.0.82.js',
        '@6to5': 'https://jspm.io/6to5@3.3.7.js'
      }
    });
