...
System.version = '0.19.16 Standard';
  // -- exporting --
...
if (typeof Promise === 'undefined' || !hasURL) {
  ...
  if (typeof document !== 'undefined') {
    ...
    document.write(
      '<' + 'script type="text/javascript" src="' + basePath + 'system-polyfills@0.19.16.js">' + '<' + '/script>'
    );
  }
  // importScripts
    ...
    importScripts(basePath + 'system-polyfills@0.19.16.js');
    bootstrap();
  }
  else {
    bootstrap();
  ...
  var upgrade = global.systemJSBootstrap;
  global.systemJSBootstrap = function() {
    if (upgrade)
      upgrade();
    ...
    global.systemJSBootstrap = undefined;
  }
  if (!upgrade)
    global.systemJSBootstrap();
